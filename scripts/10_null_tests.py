...
ap.add_argument("--rss", type=float, default=2.5, help="PFSS source-surface height in solar radii")
args = ap.parse_args()
rss = args.rss
tag = f"rss{rss:.1f}"
...
gf = b / "data" / "processed" / "comparison" / tag / "pfss_omni_ballistic_phase10_binned.csv"
bf = b / "data" / "processed" / "comparison" / tag / "pfss_omni_ballistic_correlation_summary.csv"
pf = b / "data" / "processed" / "comparison" / tag / "pfss_omni_phase_correlation_summary.csv"
ff = b / "data" / "processed" / "comparison" / tag / "pfss_omni_fixed_lag_scan_correlations.csv"
mf = b / "metadata" / "rotation_manifest.csv"

cd = b / "data" / "processed" / "comparison" / tag
fd = b / "outputs" / "figures" / "comparison" / tag
td = b / "outputs" / "tables" / tag
